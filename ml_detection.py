...
def prepare_data():
    ...
    ssh_features = ssh_logs[['src_ip', 'hour', 'day_of_week', 'attack_type']]
    web_features = web_logs[['src_ip', 'hour', 'day_of_week', 'attack_type']]
    ...
    features = all_logs[['src_ip', 'hour', 'day_of_week']]
...
def train_model():
    ...
    features_balanced, labels_balanced = handle_imbalance(features, labels)
